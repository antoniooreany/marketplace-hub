...
def get_products() -> Response:
    ...
    products: list[Product] = AppService.get_all_products(workspace_id=1) # Updated call
...
def create_product() -> tuple[Response, int]:
    try:
        ...
        product: Product = AppService.create_product(data=data, workspace_id=1) # Updated call
